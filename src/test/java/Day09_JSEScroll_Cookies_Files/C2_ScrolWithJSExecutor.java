...
//    go to url : https://api.jquery.com/dblclick/
    ...
    //mavi kareye git , tıkla , tıkladıgında sarı oldugunu yazdir.   allta
    ...
    public void doubleClickButton() {
        ...
        WebElement blueBox= driver.findElement(By.cssSelector("body>div"));// badinin icinde bir div oldugu icin bu sekilde yaptık
        JavascriptExecutor jse= (JavascriptExecutor) driver;//iframe girdik
        jse.executeScript("arguments[0].scrollIntoView();", blueBox);// mavi kutuya kadar in

        System.out.println("colour before: "+blueBox.getCssValue("background-color"));// arka plan onceki rengi
        Actions actions= new Actions(driver);
        actions.doubleClick(blueBox).perform();// kutuyu tikla
        System.out.println("colour before: "+blueBox.getCssValue("background-color"));// arka plansonraki rengi
    }
}